...
class Config:
    ...
    PLUGINS_REPO = getenv("PLUGINS_REPO", "corruptcrew/AllAtomic")
    DEPLOY_REPO = getenv("DEPLOY_REPO", "corruptcrew/AllAtomic")
    ...
    FONT_PATH = "./AllAtomic/resources/fonts/Montserrat.ttf"
