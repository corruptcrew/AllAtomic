...
from Hellbot.core import AllAtomic
...
async def anime(_, message: Message):
    if len(message.command) < 2:
        return await AllAtomic.delete(message, "Give me an anime name to search!")
...
async def manga(_, message: Message):
    if len(message.command) < 2:
        return await AllAtomic.delete(message, "Give me a manga name to search!")
...
async def character(_, message: Message):
    if len(message.command) < 2:
        return await AllAtomic.delete(message, "Give me a character name to search!")
...
async def anilist_user(_, message: Message):
    if len(message.command) < 2:
        return await AllAtomic.delete(message, "Give me an anilist username to search!")
