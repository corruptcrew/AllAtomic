...
async def blacklists(client: Client, message: Message):
    ...
    if not blacklists:
        return await AllAtomic.delete(message, "No blacklists found.")
