...
async def purgeMsg(client: Client, message: Message):
    ...
    hell = await AllAtomic.edit(message, "__Purging...__")
    ...
    await AllAtomic.delete(hell, f"__🧹 Purged {deleted} messages.__")
...
async def purgeMe(client: Client, message: Message):
    ...
    try:
        ...
        return await AllAtomic.delete(message, "Argument must be an integer.")
    ...
    await AllAtomic.delete(hell, f"__🧹 Purged {count} messages.__")
