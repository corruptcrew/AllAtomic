...
async def clone(client: Client, message: Message):
    ...
    if replied_user.is_self:
        return await AllAtomic.delete(message, "I can't clone myself!")

    hell = await AllAtomic.edit(message, "Cloning ...")
...
async def revert(client: Client, message: Message):
    ...
    if not first_name:
        return await AllAtomic.delete(message, "I'm not cloned yet.")

    hell = await AllAtomic.edit(message, "Reverting ...")
