...
from . import HELP_MSG, START_MSG, BotHelp, Config, AllAtomic


@AllAtomic.bot.on_message(filters.command("start") & Config.AUTH_USERS)
...
@AllAtomic.bot.on_message(filters.command("help") & Config.AUTH_USERS)
...
@AllAtomic.bot.on_message(filters.command("restart") & Config.AUTH_USERS)
