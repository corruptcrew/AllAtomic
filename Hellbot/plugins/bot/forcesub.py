...
from . import BotHelp, Config, Symbols, db, AllAtomic


@AllAtomic.bot.on_message(filters.command("forcesub") & Config.AUTH_USERS & filters.group)
...
@AllAtomic.bot.on_message(filters.command("unforcesub") & Config.AUTH_USERS)
...
@AllAtomic.bot.on_message(filters.command("listforcesub") & Config.AUTH_USERS)
...
@AllAtomic.bot.on_message(filters.command("getforcesub") & Config.AUTH_USERS)
...
@AllAtomic.bot.on_callback_query(filters.regex(r"forcesub"))
